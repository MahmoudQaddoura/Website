<?php
   ...
   $result = mysqli_query($conn, "SELECT * FROM pastries WHERE id = '$id'");
   $row = mysqli_fetch_assoc($result);
   // insert the product into the cart table
   mysqli_query($conn, "INSERT INTO shopping_cart.cart (product_name, price) VALUES ('" . $row['pastry_name'] . "', '" . $row['price'] . "')");
